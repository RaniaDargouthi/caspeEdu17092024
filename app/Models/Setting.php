...
class Setting extends Model implements TranslatableContract
{
    ...
    //statics
    static $pagesSeoMetas = [
        'home', 'search', 'categories', 'classes', 'login', 'register', 'contact', 'blog', 'certificate_validation',
    ...
    static $rootColors = [
        'primary', "primary-border", "primary-hover", "primary-border-hover",

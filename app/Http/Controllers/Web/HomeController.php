...
class HomeController extends Controller
{
    public function index()
    {
        ...
        if (in_array(HomeSection::$discount_classes, $selectedSectionsName)) {
            ...
            $hasDiscountWebinars = Webinar::whereIn('id', array_unique($bookIdsHasDiscount))
                ->where('status', Webinar::$active)
                ->where('private', false)
                ->with([
                    'teacher' => function ($qu) {
        ...
        return view(getTemplate() . '.pages.home', $data, ['ebooks' => $ebooks,'books' => $books]);
    }
    // RECENTLY ADDED
    public function ebooks(){
        ...
        $ebooks = DB::table('ebooks')->get();
        //dd($ebooks);
        return view(getTemplate() . '.pages.ebooks', ['ebooks' => $ebooks]);
    }
    public function books(){

        $books = DB::table('books')->get();
        return view(getTemplate() . '.pages.books', ['books' => $books]);
    }
    public function testQuizzes(){

        $ebooks = DB::table('books')->get();
        //dd($ebooks);
        return view(getTemplate() . '.pages.quizzes', ['books' => $ebooks]);
    }
    public function levels(){

        $levels = DB::table('level')->get();
        //dd($ebooks);
        return view(getTemplate() . '.pages.levels', ['levels' => $levels]);
    }
    public function levelTests(){

        $ebooks = DB::table('ebooks')->get();
        //dd($ebooks);
        return view(getTemplate() . '.pages.level-tests', ['ebooks' => $ebooks]);
    }
    public function cds(){

        $ebooks = DB::table('ebooks')->get();
        //dd($ebooks);
        return view(getTemplate() . '.pages.cds', ['ebooks' => $ebooks]);
    }
    public function contactUs(){
        return view(getTemplate() . '.pages.contact');
    }

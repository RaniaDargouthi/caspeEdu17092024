...
class WebinarsController extends Controller
{
    public function show($id)
    {
        ...
        $book = Webinar::where('id', $id)
            ...
            ->where('status', 'active')
            ->first();
        return apiResponse2(1, 'retrieved', trans('api.public.retrieved'), [$book]);
    }
    ...
    public function myClasses(Request $request)
    {
        ...
        })->handleFilters()->orderBy('updated_at', 'desc')->get()->map(function ($book) {
            return $book->brief;
        });
    ...
    public function purchases()
    {
        ...
        $books = Sale::where('sales.buyer_id', $user->id)
    ...
    public function invitations(Request $request)
    {
        ...
        $books = Webinar::where('status', 'active')
            ...
            ->handleFilters()
            ->orderBy('updated_at', 'desc')->get()->map(function ($book) {
                return $book->brief;
            });
    ...
    public function organizations()
    {
        ...
        $books = Webinar::where('creator_id', $user->organ_id)

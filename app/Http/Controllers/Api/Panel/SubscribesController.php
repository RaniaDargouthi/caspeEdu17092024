...
class SubscribesController extends Controller
{
    ...
    public function apply(Request $request)
    {
        ...
        $book = Webinar::find($request->input('webinar_id'));
        ...
        $checkCourseForSale = $book->canAddToCart($user);
        ...
        if ($checkCourseForSale != 'ok') {
            return apiResponse2(0, $checkCourseForSale,
                $book->checkCourseForSaleMsg(), null,
                trans('public.request_failed')
        ...
        Accounting::createAccountingForSaleWithSubscribe($book, $subscribe);
    ...
    public function generalApply(Request $request)
    {
        ...
        $sale = Sale::create([
            ...
            'subscribe_id' => $subscribe->id,
            'type' => $item_name == 'webinar' ? Sale::$book : Sale::$bundle,
            'payment_method' => Sale::$subscribe,
            'amount' => 0,
            'total_amount' => 0,
            'created_at' => time(),

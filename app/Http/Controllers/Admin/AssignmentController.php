    ...
    public function store(Request $request)
    {
        ...
        if (!empty($book)) {
            ...
            if ($assignment) {
                ...
                $this->handleAttachments($data['attachments'], $book->creator_id, $assignment->id);

                if (!empty($assignment->chapter_id)) {
                    WebinarChapterItem::makeItem($book->creator_id, $assignment->chapter_id, $assignment->id, WebinarChapterItem::$chapterAssignment);
                }
            }

...
trait DashboardTrait
{
    public function dailySalesTypeStatistics()
    {
        ...
        $booksSales = Sale::whereNull('refund_at')
        ...
        $allSales = Sale::whereNull('refund_at')
            ->whereIn('type', [Sale::$book, Sale::$meeting])
            ->whereBetween('created_at', [$beginOfDay, $endOfDay])
            ->count();


        return [
            'webinarsSales' => $booksSales,
    ...
    public function getRecentWebinars()
    {
        ...
        $books = Webinar::where('type', Webinar::$book)
            ->orderBy('created_at', 'desc')
            ->limit(5)
            ->get();

        $pendingReviews = Webinar::where('type', Webinar::$book)
    ...
    {
        $labels = [Webinar::$book, Webinar::$course, Webinar::$textLesson];
        $data = [];

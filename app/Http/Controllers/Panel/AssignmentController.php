...
class AssignmentController extends Controller
{
    public function myAssignments(Request $request)
    {
        ...
        $books = Webinar::select('id', 'creator_id', 'teacher_id')
    ...
    public function students(Request $request, $id)
    {
        ...
        if (!empty($assignment)) {
            ...
            $studentsIds = Sale::where('webinar_id', $book->id)
                ->whereNull('refund_at')
                ->pluck('buyer_id')
                ->toArray();
    ...
    public function destroy(Request $request, $id)
    {
        ...
        if (!empty($assignments)) {
            $book = Webinar::query()->find($assignments->webinar_id);

            if ($assignments->creator_id == $user->id or (!empty($book) and $book->canAccess($user))) {

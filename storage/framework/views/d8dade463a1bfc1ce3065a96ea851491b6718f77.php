        ...
        <div class="rounded-lg shadow-sm px-25 py-20 px-lg-50 py-lg-35 position-relative user-profile-info bg-white">
            ...
            <div class="row mt-30 w-100 d-flex align-items-center justify-content-around">
                ...
                <div class="col-6 col-md-3 user-profile-state d-flex flex-column align-items-center">
                    ...
                    <span class="font-20 text-dark-blue font-weight-bold mt-5"><?php echo e(count($books)); ?></span>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ranya/Bureau/projet-jaafar/resources/views/web/default/user/profile.blade.php ENDPATH**/ ?>
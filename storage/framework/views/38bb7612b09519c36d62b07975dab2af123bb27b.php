                        ...
                        <div class="form-group">
                            ...
                            <select name="webinar" class="form-control select2" data-placeholder="<?php echo e(trans('public.all')); ?>">
                                ...
                                <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($book->id); ?>" <?php if(request()->get('webinar') == $book->id): ?> selected <?php endif; ?>><?php echo e($book->title); ?> <?php if(in_array($book->id,$purchasedWebinarsIds)): ?> (<?php echo e(trans('panel.purchased')); ?>) <?php endif; ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ranya/Bureau/projet-jaafar/resources/views/web/default/panel/support/conversations.blade.php ENDPATH**/ ?>
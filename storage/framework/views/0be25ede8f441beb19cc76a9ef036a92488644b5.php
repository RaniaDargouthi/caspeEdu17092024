                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-3 mt-25 mt-lg-0">
                        <div class="stats-item d-flex flex-column align-items-center text-center py-30 px-5 w-100">
                            ...
                            <h4 class="stat-title">التلاميذ</h4>
                    ...
                    <div class="col-sm-6 col-lg-3 mt-25 mt-lg-0">
                        <div class="stats-item d-flex flex-column align-items-center text-center py-30 px-5 w-100">
                            ...
                            <strong class="stat-number mt-10">--</strong>
                            <h4 class="stat-title">كتاب الكتروني</h4>
                            <p class="stat-desc mt-10">ادعم نفسك بالكتب الالكترونية</p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-3 mt-25 mt-lg-0">
                        <div class="stats-item d-flex flex-column align-items-center text-center py-30 px-5 w-100">
                            ...
                            <strong class="stat-number mt-10">--</strong>
                            <h4 class="stat-title">تمارين تفاعلي</h4>
                            <p class="stat-desc mt-10">حسن مستواك الى الاكثر بالتمارينات</p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php else: ?>
    <div class="my-40"></div>
<?php endif; ?>
<?php /**PATH /home/ranya/Bureau/caspeeducation 1709/resources/views/web/default/pages/includes/home_statistics.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('content'); ?>
    <section class="">
        ...
        <style>
            .background-div {
                background-image: url('<?php echo e(getPageBackgroundSettings('dashboard')); ?>');
                background-size: cover;
                /* Ajuste la taille de l'image pour remplir complètement la div */
                background-position: center;
                /* Centre l'image dans la div */
            }
        </style>
        <div class="bg-white position-relative px-15 px-ld-35 py-10 panel-shadow rounded-sm background-div">

            <h2 class="font-30 text-primary line-height-1">
                <span class="d-block"><?php echo e(trans('admin/main.welcome')); ?> <?php echo e($authUser->full_name); ?>,</span>
                <span
            ...
            <div class="col-12 col-lg-3 mt-35">
                <a href="<?php if($authUser->isUser()): ?> /panel/webinars/purchases <?php else: ?> /panel/meetings/requests <?php endif; ?>"
                    ...
                    <div class="d-flex flex-column ml-15">
                        <span
                            class="font-30 text-secondary"><?php echo e(!empty($pendingAppointments) ? $pendingAppointments : (!empty($booksCount) ? $booksCount : 0)); ?></span>
                        <span
...
<?php echo $__env->make(getTemplate() . '.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ranya/Bureau/caasp/projet-jaafar/resources/views/web/default/panel/dashboard/index.blade.php ENDPATH**/ ?>
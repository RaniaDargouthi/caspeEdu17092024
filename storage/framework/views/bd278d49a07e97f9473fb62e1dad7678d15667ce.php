            ...
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-12 col-md-9 col-lg-7">
                    <div class="top-search-categories-form">
                        ...
                        <span
                            class="course-count-badge py-5 px-10 text-white rounded"><?php echo e($booksCount); ?> <?php echo e(trans('product.courses')); ?></span>
    ...
    <div class="container mt-30">
        ...
        <section class="mt-lg-50 pt-lg-20 mt-md-40 pt-md-40">
                ...
                <div class="row mt-20">
                    <div class="col-12 col-lg-8">
                            ...
                            <div class="row">
                                <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-12 col-lg-6 mt-20">
                                        <?php echo $__env->make('web.default.includes.webinar.grid-card',['webinar' => $book], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        ...
                        <?php elseif(!empty(request()->get('card')) and request()->get('card') == 'list'): ?>
                            ...
                            <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php echo $__env->make('web.default.includes.webinar.list-card',['webinar' => $book], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-20">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" name="type[]"
                                                       ...
                                                       <?php if(in_array($typeOption, request()->get('type', []))): ?> checked="checked"
                                        ...
                                        <?php if(!empty($filter->options)): ?>
                                            <div class="pt-10">
                                                <?php $__currentLoopData = $filter->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div
                                                        class="d-flex align-items-center justify-content-between mt-20">
                                                        <label class="cursor-pointer"
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" name="filter_option[]"
                                                                   ...
                                                                   <?php if(in_array($option->id, request()->get('filter_option', []))): ?> checked="checked"
                                                                   <?php endif; ?> class="custom-control-input">
                                                            <label class="custom-control-label"
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-20">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" name="moreOptions[]"
                                                       ...
                                                       <?php if(in_array($moreOption, request()->get('moreOptions', []))): ?> checked="checked"
                                                       <?php endif; ?> class="custom-control-input">
                                                <label class="custom-control-label"
            ...
            <div class="mt-50 pt-30">
                <?php echo e($books->appends(request()->input())->links('vendor.pagination.panel')); ?>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ranya/Bureau/projet-jaafar/resources/views/web/default/pages/categories.blade.php ENDPATH**/ ?>
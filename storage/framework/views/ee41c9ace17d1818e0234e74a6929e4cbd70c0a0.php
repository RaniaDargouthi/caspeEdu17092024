                ...
                <?php if(!empty($recentWebinars)): ?>
                    <div class="col-md-4">
                        <div class="card card-hero">
                            ...
                            <div class="card-body p-0">
                                <div class="tickets-list">
                                    <?php $__currentLoopData = $recentWebinars['webinars']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(getAdminPanelUrl()); ?>/webinars/<?php echo e($book->id); ?>/edit" class="ticket-item">
                                            <div class="ticket-title">
                                                <h4><?php echo e($book->title); ?></h4>
                                            </div>

                                            <div class="ticket-info">
                                                <div><?php echo e($book->teacher->full_name); ?></div>
                                                <div class="bullet"></div>
                                                <?php switch($book->status):
                                                    case (\App\Models\Webinar::$active): ?>
                                                    <span class="text-success"><?php echo e(trans('admin/main.publish')); ?></span>
                                                    <?php if($book->isProgressing()): ?>
                                                        <div class="text-warning text-small font-600-bold">(<?php echo e(trans('webinars.in_progress')); ?>)</div>
                                                    <?php elseif($book->start_date > time()): ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ranya/Bureau/caasp/projet-jaafar/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>
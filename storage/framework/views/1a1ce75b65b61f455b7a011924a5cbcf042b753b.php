   ...
   margin-bottom: 120px !important ;
    ...
    <section class="home-sections home-sections-swiper container">
        <div class="d-flex justify-content-between ">
            <div>
                <h2 class="section-title">الكتب الالكترونية</h2>
            </div>
                            ...
                            <div class="webinar-card">
                                <figure >
                                    <div class="image-box" style="position: relative;">
                                        <span class="badge badge-primary"><?php echo e($ebook->price); ?> $</span>

                                        <a  href="<?php echo e(asset('/store/uploads/books-resources/'.$ebook->file)); ?>"
                                        
                                        >
                                            <div class="image-overlay" style="">
                                                
                                            </div>
                                            <img src="/store/uploads/<?php echo e($ebook->cover); ?>" class="img-cover">
                                        </a>
                                    </div>
                            ...
                            <div class="webinar-card">
                                <figure>
                                    ...
                                    <figcaption class="webinar-card-body">
                                        <a href="https://casp.education/course/course-ecole">
                                            <h3 class="mt-15 webinar-title font-weight-bold font-16 text-dark-blue">كتاب: <?php echo e($book->title); ?></h3>
                                        </a>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span class="d-inline-block font-14 mt-10">
                                                <a href="/categories/لغة-عربية" target="_blank" class="text-decoration-underline">عرض</a>
                                            </span>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ranya/Bureau/projet-jaafar/resources/views/web/default/pages/home.blade.php ENDPATH**/ ?>
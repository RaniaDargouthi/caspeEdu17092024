                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom"
                    ...
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            <div class="mb-2 pb-3">
                                <h1 class="mb-2 display-4 font-weight-bold">CASP EDUCATION</h1>
                            </div>
                            All rights reserved for <a class="text-light bb" target="_blank" href="#">CASP
                                EDUCATION</a>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /home/ranya/Bureau/caasp/projet-jaafar/resources/views/admin/auth/auth_layout.blade.php ENDPATH**/ ?>
            ...
            <div class="row">
                ...
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 font-weight-bold mt-5 text-dark-blue">{{ $bookCount }}</strong>
                        ...
                        <div class="col-12 col-lg-5">
                            <div class="form-group">
                                ...
                                <select name="webinar_id" class="form-control select2">
                                    ...
                                    @foreach($userWebinars as $book)
                                        <option value="{{ $book->id }}" @if(request()->get('webinar_id',null) == $book->id) selected @endif>{{ $book->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>

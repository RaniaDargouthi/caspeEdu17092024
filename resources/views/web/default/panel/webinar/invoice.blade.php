                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="invoice-title">
                                                            ...
                                                            <div class="invoice-number">{{ trans('public.item_id') }}: #{{ $book->id }}</div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <address>
                                                                    ...
                                                                    @if($book->tracher_id != $book->creator_id)
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <address>
                                                                    ...
                                                                    {{ $book->teacher->full_name }} <br>

                                                                    @if(!empty($book->webinarPartnerTeacher) and count($book->webinarPartnerTeacher))
                                                                        @foreach($book->webinarPartnerTeacher as $partner)
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-striped table-hover table-md">
                                                                ...
                                                                <tr>
                                                                    <td>{{ $book->id }}</td>
                                                                    <td>{{ $book->title }}</td>
                                                                    <td class="text-center">{{ trans('webinars.'.$book->type) }}</td>

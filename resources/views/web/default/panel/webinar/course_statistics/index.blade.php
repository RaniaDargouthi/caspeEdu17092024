            ...
            <div class="col-12 col-md-3 mt-20">
                <div class="course-statistic-cards-shadow py-20 px-15 py-md-30 px-md-20 rounded-sm bg-white">
                    <div class="d-flex align-items-center flex-column">
                        ...
                        <span class="font-30 text-secondary mt-25 font-weight-bold">{{ $book->quizzes->count() }}</span>
            ...
            <div class="col-12 col-md-3 mt-20">
                <div class="course-statistic-cards-shadow py-20 px-15 py-md-30 px-md-20 rounded-sm bg-white">
                    <div class="d-flex align-items-center flex-column">
                        ...
                        <span class="font-30 text-secondary mt-25 font-weight-bold">{{ $book->assignments->count() }}</span>

                        ...
                        <div class="form-group">
                            ...
                            <select name="webinar" class="form-control select2" data-placeholder="{{ trans('public.all') }}">
                                ...
                                @foreach($books as $book)
                                    <option value="{{ $book->id }}" @if(request()->get('webinar') == $book->id) selected @endif>{{ $book->title }} @if(in_array($book->id,$purchasedWebinarsIds)) ({{ trans('panel.purchased') }}) @endif</option>
                                @endforeach
                            </select>
                        </div>
                    </div>

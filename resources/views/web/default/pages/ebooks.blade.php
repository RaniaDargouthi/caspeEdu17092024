                            ...
                            <div class="webinar-card">
                                <figure>
                                    <div class="image-box" style="position: relative;">
                                        <span class="badge badge-primary">{{ $ebook->price }} $</span>

                                        <a href="{{ $ebook->file }}">
                                            <div class="image-overlay" style="">
{{--                                                <di>     {{ $ebook->title }}--}}
{{--                                                </di>--}}
{{--                                                <div class="d-block font-14 mt-10">--}}
{{--                                                    <a href="{{ $ebook->file }}" target="_blank" class="text-decoration-underline">عرض</a>--}}
{{--                                                </div>--}}
                                            </div>
                                            <img src="/store/uploads/{{ $ebook->cover }}" class="img-cover">
                                        </a>
                                    </div>
            ...
            {{-- <div class="d-flex justify-content-center">
                <div
                    class="swiper-pagination latest-webinars-swiper-pagination swiper-pagination-clickable swiper-pagination-bullets">

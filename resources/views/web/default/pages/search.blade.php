...
@section('content')
    @if((!empty($books) and count($books)) or (!empty($products) and count($products)) or (!empty($teachers) and count($teachers)) or (!empty($organizations) and count($organizations)))
        ...
        <div class="container">
            @if(!empty($books) and count($books))
                <section class="mt-50">
                    ...
                    <div class="row">
                        @foreach($books as $book)
                            <div class="col-md-6 col-lg-4 mt-30">
                                @include(getTemplate().'.includes.webinar.grid-card',['webinar' => $book])
                            </div>
                        @endforeach
                    </div>
                </section>

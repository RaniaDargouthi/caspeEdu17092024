            ...
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-12 col-md-9 col-lg-7">
                    <div class="top-search-categories-form">
                        ...
                        <span
                            class="course-count-badge py-5 px-10 text-white rounded">{{ $booksCount }} {{ trans('product.courses') }}</span>
                ...
                <div class="row mt-20">
                    <div class="col-12 col-lg-8">
                        ...
                        @elseif(!empty(request()->get('card')) and request()->get('card') == 'list')
                            ...
                            @foreach($books as $book)
                                @include('web.default.includes.webinar.list-card',['webinar' => $book])
                            @endforeach
                        @endif
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-20">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" name="type[]"
                                                       ...
                                                       @if(in_array($typeOption, request()->get('type', []))) checked="checked"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" name="filter_option[]"
                                                                   ...
                                                                   value="{{ $option->id }}"
                                                                   @if(in_array($option->id, request()->get('filter_option', []))) checked="checked"
                                                                   @endif class="custom-control-input">
                                                            <label class="custom-control-label"
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-20">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" name="moreOptions[]"
                                                       ...
                                                       @if(in_array($moreOption, request()->get('moreOptions', []))) checked="checked"
                                                       @endif class="custom-control-input">
                                                <label class="custom-control-label"

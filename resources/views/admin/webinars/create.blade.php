...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{!empty($book) ?trans('/admin/main.edit'): trans('admin/main.new') }} {{ trans('admin/main.class') }}</h1>
                ...
                <div class="col-12 ">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ getAdminPanelUrl() }}/webinars/{{ !empty($book) ? $book->id.'/update' : 'store' }}" id="webinarForm" class="webinar-form">
                                {{ csrf_field() }}
                                <section>
                                        ...
                                        <div class="col-12 col-md-5">
                                            ...
                                            <div class="form-group mt-15 ">
                                                ...
                                                <select name="type" class="custom-select @error('type')  is-invalid @enderror">
                                                    <option value="webinar" @if((!empty($book) and $book->isWebinar()) or old('type') == \App\Models\Webinar::$book) selected @endif>{{ trans('webinars.webinar') }}</option>
                                                    <option value="course" @if((!empty($book) and $book->isCourse()) or old('type') == \App\Models\Webinar::$course) selected @endif>{{ trans('product.video_course') }}</option>
                                                    <option value="text_lesson" @if((!empty($book) and $book->isTextCourse()) or old('type') == \App\Models\Webinar::$textLesson) selected @endif>{{ trans('product.text_course') }}</option>
                                                </select>
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <input type="text" name="title" value="{{ !empty($book) ? $book->title : old('title') }}" class="form-control @error('title')  is-invalid @enderror" placeholder=""/>
                                                @error('title')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <input type="number" name="points" value="{{ !empty($book) ? $book->points : old('points') }}" class="form-control @error('points')  is-invalid @enderror" placeholder="Empty means inactive this mode"/>
                                                @error('points')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <input type="text" name="slug" value="{{ !empty($book) ? $book->slug : old('slug') }}" class="form-control @error('slug')  is-invalid @enderror" placeholder=""/>
                                            ...
                                            @if(!empty($book) and $book->creator->isOrganization())
                                                <div class="form-group mt-15 ">
                                                    ...
                                                    <select name="organ_id" data-search-option="just_organization_role" class="form-control search-user-select2" data-placeholder="{{ trans('search_organization') }}">
                                                        <option value="{{ $book->creator->id }}" selected>{{ $book->creator->full_name }}</option>
                                                    </select>
                                                </div>
                                            @endif
                                            ...
                                            <div class="form-group mt-15 ">
                                                ...
                                                >
                                                    @if(!empty($book))
                                                        <option value="{{ $book->teacher->id }}" selected>{{ $book->teacher->full_name }}</option>
                                                    @else
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <input type="text" name="seo_description" value="{{ !empty($book) ? $book->seo_description : old('seo_description') }}" class="form-control @error('seo_description')  is-invalid @enderror"/>
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="thumbnail" id="thumbnail" value="{{ !empty($book) ? $book->thumbnail : old('thumbnail') }}" class="form-control @error('thumbnail')  is-invalid @enderror"/>
                                                ...
                                                <div class="">
                                                    ...
                                                    >
                                                        @foreach(\App\Models\Webinar::$videoDemoSource as $source)
                                                            <option value="{{ $source }}" @if(!empty($book) and $book->video_demo_source == $source) selected @endif>{{ trans('update.file_source_'.$source) }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mt-0">
                                                ...
                                                <div class="input-group js-video-demo-path-input">
                                                    <div class="input-group-prepend">
                                                        <button type="button" class="js-video-demo-path-upload input-group-text admin-file-manager {{ (empty($book) or empty($book->video_demo_source) or $book->video_demo_source == 'upload') ? '' : 'd-none' }}" data-input="demo_video" data-preview="holder">
                                                            <i class="fa fa-upload"></i>
                                                        </button>

                                                        <button type="button" class="js-video-demo-path-links rounded-left input-group-text input-group-text-rounded-left  {{ (empty($book) or empty($book->video_demo_source) or $book->video_demo_source == 'upload') ? 'd-none' : '' }}">
                                                            <i class="fa fa-link"></i>
                                                        </button>
                                                    </div>
                                                    <input type="text" name="video_demo" id="demo_video" value="{{ !empty($book) ? $book->video_demo : old('video_demo') }}" class="form-control @error('video_demo')  is-invalid @enderror"/>
                                                    @error('video_demo')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group mt-15">
                                                ...
                                                <textarea id="summernote" name="description" class="form-control @error('description')  is-invalid @enderror" placeholder="{{ trans('forms.webinar_description_placeholder') }}">{!! !empty($book) ? $book->description : old('description')  !!}</textarea>
                                                @error('description')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <input type="number" name="capacity" value="{{ !empty($book) ? $book->capacity : old('capacity') }}" class="form-control @error('capacity')  is-invalid @enderror"/>
                                                @error('capacity')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                            ...
                                            <div class="row mt-15">
                                                @if(empty($book) or (!empty($book) and $book->isWebinar()))
                                                    <div class="col-12 col-md-6 js-start_date {{ (!empty(old('type')) and old('type') != \App\Models\Webinar::$book) ? 'd-none' : '' }}">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="start_date" value="{{ (!empty($book) and $book->start_date) ? dateTimeFormat($book->start_date, 'Y-m-d H:i', false, false, $book->timezone) : old('start_date') }}" class="form-control @error('start_date')  is-invalid @enderror datetimepicker" aria-describedby="dateInputGroupPrepend"/>
                                                                @error('start_date')
                                                                <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" name="duration" value="{{ !empty($book) ? $book->duration : old('duration') }}" class="form-control @error('duration')  is-invalid @enderror"/>
                                                            @error('duration')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                            ...
                                            @if(getFeaturesSettings('timezone_in_create_webinar'))
                                                @php
                                                    ...
                                                    if (!empty($book) and !empty($book->timezone)) {
                                            ...
                                            @if(!empty($book) and $book->creator->isOrganization())
                                                <div class="form-group mt-30 d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" name="private" class="custom-control-input" id="privateSwitch" {{ (!empty($book) and $book->private) ? 'checked' :  '' }}>
                                            ...
                                            <div class="form-group mt-30 d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" name="support" class="custom-control-input" id="supportSwitch" {{ !empty($book) && $book->support ? 'checked' : '' }}>
                                            ...
                                            <div class="form-group mt-30 d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" name="certificate" class="custom-control-input" id="includeCertificateSwitch" {{ !empty($book) && $book->certificate ? 'checked' : '' }}>
                                            ...
                                            <div class="form-group mt-30 d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" name="downloadable" class="custom-control-input" id="downloadableSwitch" {{ !empty($book) && $book->downloadable ? 'checked' : '' }}>
                                            ...
                                            <div class="form-group mt-30 d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" name="partner_instructor" class="custom-control-input" id="partnerInstructorSwitch" {{ !empty($book) && $book->partner_instructor ? 'checked' : ''  }}>
                                            ...
                                            <div class="form-group mt-30 d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" name="forum" class="custom-control-input" id="forumSwitch" {{ !empty($book) && $book->forum ? 'checked' : ''  }}>
                                            ...
                                            <div class="form-group mt-30 d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" name="subscribe" class="custom-control-input" id="subscribeSwitch" {{ !empty($book) && $book->subscribe ? 'checked' : ''  }}>
                                            ...
                                            <div class="form-group mt-30 d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" name="enable_waitlist" class="custom-control-input" id="enable_waitlistSwitch" {{ (!empty($book) and $book->enable_waitlist) ? 'checked' : ''  }}>
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <input type="text" name="access_days" value="{{ !empty($book) ? $book->access_days : old('access_days') }}" class="form-control @error('access_days')  is-invalid @enderror"/>
                                                @error('access_days')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <input type="text" name="price" value="{{ (!empty($book) and !empty($book->price)) ? convertPriceToUserCurrency($book->price) : old('price') }}" class="form-control @error('price')  is-invalid @enderror" placeholder="{{ trans('public.0_for_free') }}"/>
                                                @error('price')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                            ...
                                            <div id="partnerInstructorInput" class="form-group mt-15 {{ (!empty($book) && $book->partner_instructor) ? '' : 'd-none' }}">
                                                <label class="input-label d-block">{{ trans('public.select_a_partner_teacher') }}</label>

                                                <select name="partners[]" multiple data-search-option="just_teacher_role" class="js-search-partner-user form-control {{ (!empty($book) && $book->partner_instructor) ? 'search-user-select22' : '' }}"
                                                        data-placeholder="{{ trans('public.search_instructor') }}"
                                                >
                                                    @if(!empty($bookPartnerTeacher))
                                                        @foreach($bookPartnerTeacher as $partner)
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <input type="text" name="tags" data-max-tag="5" value="{{ !empty($book) ? implode(',',$bookTags) : '' }}" class="form-control inputtags" placeholder="{{ trans('public.type_tag_name_and_press_enter') }} ({{ trans('admin/main.max') }} : 5)"/>
                                            </div>
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <select id="categories" class="custom-select @error('category_id')  is-invalid @enderror" name="category_id" required>
                                                    <option {{ !empty($book) ? '' : 'selected' }} disabled>{{ trans('public.choose_category') }}</option>
                                                    @foreach($categories as $category)
                                                        @if(!empty($category->subCategories) and count($category->subCategories))
                                                            <optgroup label="{{  $category->title }}">
                                                                @foreach($category->subCategories as $subCategory)
                                                                    <option value="{{ $subCategory->id }}" {{ (!empty($book) and $book->category_id == $subCategory->id) ? 'selected' : '' }}>{{ $subCategory->title }}</option>
                                                                @endforeach
                                                            </optgroup>
                                                        @else
                                                            <option value="{{ $category->id }}" {{ (!empty($book) and $book->category_id == $category->id) ? 'selected' : '' }}>{{ $category->title }}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                ...
                                @if(!empty($book))
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            @foreach($tickets as $ticket)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <button type="button" data-ticket-id="{{ $ticket->id }}" data-webinar-id="{{ !empty($book) ? $book->id : '' }}" class="edit-ticket btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
                                                            ...
                                                            @foreach($prerequisites as $prerequisite)
                                                                @if(!empty($prerequisite->prerequisiteWebinar->title))
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <button type="button" data-prerequisite-id="{{ $prerequisite->id }}" data-webinar-id="{{ !empty($book) ? $book->id : '' }}" class="edit-prerequisite btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
                                                                                <i class="fa fa-edit"></i>
                                                                            </button>
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            @foreach($faqs as $faq)
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right">
                                                                        <button type="button" data-faq-id="{{ $faq->id }}" data-webinar-id="{{ !empty($book) ? $book->id : '' }}" class="edit-faq btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>
                                    ...
                                    @foreach(\App\Models\WebinarExtraDescription::$types as $bookExtraDescriptionType)
                                        <section class="mt-30">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <h2 class="section-title after-line">{{ trans('update.'.$bookExtraDescriptionType) }}</h2>
                                                <button id="add_new_{{ $bookExtraDescriptionType }}" type="button" class="btn btn-primary btn-sm mt-3">{{ trans('update.add_'.$bookExtraDescriptionType) }}</button>
                                            </div>
                                                    ...
                                                    @if(!empty($bookExtraDescriptionValues) and count($bookExtraDescriptionValues))
                                                        <div class="table-responsive">
                                                            <table class="table table-striped text-center font-14">
                                                                ...
                                                                <tr>
                                                                    @if($bookExtraDescriptionType == \App\Models\WebinarExtraDescription::$COMPANY_LOGOS)
                                                                ...
                                                                @foreach($bookExtraDescriptionValues as $extraDescription)
                                                                    <tr>
                                                                        @if($bookExtraDescriptionType == \App\Models\WebinarExtraDescription::$COMPANY_LOGOS)
                                                                            <td>
                                                                        ...
                                                                        <td class="text-right">
                                                                            <button type="button" data-item-id="{{ $extraDescription->id }}" data-webinar-id="{{ !empty($book) ? $book->id : '' }}" class="edit-extraDescription btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
                                                                                <i class="fa fa-edit"></i>
                                                                            </button>
                                    ...
                                    <section class="mt-30">
                                        ...
                                        <div class="row mt-10">
                                            <div class="col-12">
                                                @if(!empty($bookQuizzes) and !$bookQuizzes->isEmpty())
                                                    <div class="table-responsive">
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            @foreach($bookQuizzes as $bookQuiz)
                                                                <tr>
                                                                    <th>{{ $bookQuiz->title }}</th>
                                                                    <td>{{ $bookQuiz->quizQuestions->count() }}</td>
                                                                    <td>{{ $bookQuiz->quizQuestions->sum('grade') }}</td>
                                                                    <td>{{ $bookQuiz->pass_mark }}</td>
                                                                    <td>{{ $bookQuiz->certificate ? trans('public.yes') : trans('public.no') }}</td>
                                                                    <td>
                                                                        <button type="button" data-webinar-quiz-id="{{ $bookQuiz->id }}" data-webinar-id="{{ !empty($book) ? $book->id : '' }}" class="edit-webinar-quiz btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>

                                                                        @include('admin.includes.delete_button',['url' => getAdminPanelUrl().'/webinar-quiz/'. $bookQuiz->id .'/delete', 'btnClass' => ' mt-1'])
                                                                    </td>
                                                                    @endforeach
                                                                </tr>
                                ...
                                <section class="mt-3">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group mt-15">
                                                <textarea name="message_for_reviewer" rows="10" class="form-control">{{ (!empty($book) && $book->message_for_reviewer) ? $book->message_for_reviewer : old('message_for_reviewer') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </section>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button type="button" id="saveAndPublish" class="btn btn-success">{{ !empty($book) ? trans('admin/main.save_and_publish') : trans('admin/main.save_and_continue') }}</button>

                                        @if(!empty($book))
                                            <button type="button" id="saveReject" class="btn btn-warning">{{ ($book->status == "active") ? trans('update.unpublish') : trans('public.reject') }}</button>

                                            @include('admin.includes.delete_button',[
                                                    'url' => getAdminPanelUrl().'/webinars/'. $book->id .'/delete',

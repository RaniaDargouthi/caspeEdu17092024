                                    ...
                                    @foreach($books as $book)
                                        <tr class="text-center">
                                            ...
                                            <td width="18%" class="text-left">
                                                <a class="text-primary mt-0 mb-1 font-weight-bold" href="{{ $book->getUrl() }}">{{ $book->title }}</a>
                                                @if(!empty($book->category->title))
                                                    <div class="text-small">{{ $book->category->title }}</div>
                                                @else
                                                    <div class="text-small text-warning">{{trans('admin/main.no_category')}}</div>
                                                @endif
                                            </td>

                                            <td class="text-left">{{ $book->teacher->full_name }}</td>

                                            <td>
                                                @if(!empty($book->price) and $book->price > 0)
                                                    <span class="mt-0 mb-1">
                                                        {{ handlePrice($book->price, true, true) }}
                                                    </span>

                                                    @if($book->getDiscountPercent() > 0)
                                                        <div class="text-danger text-small font-600-bold">{{ $book->getDiscountPercent() }}% {{trans('admin/main.off')}}</div>
                                                    @endif
                                                @else
                                                    {{ trans('public.free') }}
                                                @endif
                                            ...
                                            <td>
                                                ...
                                                @if(!empty($book->capacity))
                                                    <div class="text-small font-600-bold">{{trans('admin/main.capacity')}} : {{ $book->getWebinarCapacity() }}</div>
                                                @endif
                                            </td>

                                            <td>{{ handlePrice($book->sales->sum('total_amount')) }}</td>

                                            <td class="font-12">
                                                <a href="{{ getAdminPanelUrl() }}/webinars/{{ $book->id }}/students" target="_blank" class="">{{ $book->sales->count() }}</a>
                                            </td>

                                            <td class="font-12">{{ dateTimeFormat($book->created_at, 'Y M j | H:i') }}</td>

                                            @if($classesType == 'webinar')
                                                <td class="font-12">{{ dateTimeFormat($book->start_date, 'Y M j | H:i') }}</td>
                                            @else
                                                <td class="font-12">{{ dateTimeFormat($book->updated_at, 'Y M j | H:i') }}</td>
                                            @endif
                                                ...
                                                <div class="btn-group dropdown table-actions">
                                                    ...
                                                    <div class="dropdown-menu text-left webinars-lists-dropdown">
                                                        ...
                                                        @can('admin_webinars_edit')
                                                            @if($book->status == \App\Models\Webinar::$pending)
                                                                @include('admin.includes.delete_button',[
                                                                    'url' => getAdminPanelUrl().'/webinars/'.$book->id.'/approve',
                                                                ...
                                                                @include('admin.includes.delete_button',[
                                                                    'url' => getAdminPanelUrl().'/webinars/'.$book->id.'/reject',
                                                            ...
                                                            @elseif($book->status == \App\Models\Webinar::$active)
                                                                @include('admin.includes.delete_button',[
                                                                    'url' => getAdminPanelUrl().'/webinars/'.$book->id.'/unpublish',
                                                                    'btnClass' => 'd-flex align-items-center text-danger text-decoration-none btn-transparent btn-sm mt-1',
                                                        ...
                                                        @can('admin_webinar_notification_to_students')
                                                            <a href="{{ getAdminPanelUrl() }}/webinars/{{ $book->id }}/sendNotification" target="_blank" class="d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm text-primary mt-1 ">
                                                        ...
                                                        @can('admin_webinar_students_lists')
                                                            <a href="{{ getAdminPanelUrl() }}/webinars/{{ $book->id }}/students" target="_blank" class="d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm text-primary mt-1 " title="{{ trans('admin/main.students') }}">
                                                        ...
                                                        @can('admin_webinar_statistics')
                                                            <a href="{{ getAdminPanelUrl() }}/webinars/{{ $book->id }}/statistics" target="_blank" class="d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm text-primary mt-1 " title="{{ trans('admin/main.students') }}">
                                                        ...
                                                        @can('admin_support_send')
                                                            <a href="{{ getAdminPanelUrl() }}/supports/create?user_id={{ $book->teacher->id }}" target="_blank" class="d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm text-primary mt-1" title="{{ trans('admin/main.send_message_to_teacher') }}">
                                                        ...
                                                        @can('admin_webinars_edit')
                                                            <a href="{{ getAdminPanelUrl() }}/webinars/{{ $book->id }}/edit" target="_blank" class="d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm text-primary mt-1 " title="{{ trans('admin/main.edit') }}">

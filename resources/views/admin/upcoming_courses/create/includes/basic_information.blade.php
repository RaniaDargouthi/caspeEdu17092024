    ...
    <div class="col-12 col-md-5">
        ...
        <div class="form-group mt-15 ">
            ...
            <select name="type" class="custom-select @error('type')  is-invalid @enderror">
                <option value="webinar" @if((!empty($upcomingCourse) and $upcomingCourse->type == 'webinar') or old('type') == \App\Models\Webinar::$book) selected @endif>{{ trans('webinars.webinar') }}</option>

...
@endcan  --}}
            ...
            @can('admin_webinars')
                <li
                    class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/ebooks*', false)) and !request()->is(getAdminPanelUrl('/webinars/comments*', false))) ? 'active' : '' }}">
...
{{--                            </li>--}}
                            ...
                            <li
                                class="{{ (request()->is(getAdminPanelUrl('/ebooks', false)) and request()->get('type') == 'text_lesson') ? 'active' : '' }}">
                                <a class="nav-link @if (!empty($sidebarBeeps['textLessons']) and $sidebarBeeps['textLessons']) beep beep-sidebar @endif"
                                    href="{{ getAdminPanelUrl() }}/ebooks">  قائمة الكتب   </a>
{{--                                {{ trans('admin/main.text_courses') }}--}}
                            </li>
                        @endcan()
...
{{--                            </li>--}}
                                ...
                                <li class="{{ request()->is(getAdminPanelUrl('/ebooks/new', false)) ? 'active' : '' }}">
                                    <a class="nav-link"
                                       href="{{ getAdminPanelUrl() }}/ebooks/new">اضف كتاب جديد </a>
                                </li>
                        @endcan()
...
{{--                        <span>    سلسلة التمارين   {{ trans('admin/main.quizzes') }}</span>--}}
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_organizations_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/organizations', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/organizations">مدارس</a>
                            </li>
                        @endcan()
                        ...
                        @can('admin_users_create')
                            <li class="{{ request()->is(getAdminPanelUrl('/users/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/users/create">مستخدم جديد</a>
                            </li>
                        @endcan()
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_roles_create')
                            <li class="{{ request()->is(getAdminPanelUrl('/roles/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/roles/create">اضف نوع جديد</a>
                            </li>
                        @endcan()
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_blog_lists')
                            <li class="{{ request()->is(getAdminPanelUrl('/blog', false)) ? 'active' : '' }}">
                                <a class="nav-link" href="{{ getAdminPanelUrl() }}/blog">مقالات</a>
                            </li>
                        @endcan
                        ...
                        @can('admin_blog_create')
                            <li class="{{ request()->is(getAdminPanelUrl('/blog/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/blog/create">مقال جديد</a>
                            </li>
                        @endcan
                        ...
                        @can('admin_blog_categories')
                            <li class="{{ request()->is(getAdminPanelUrl('/blog/categories', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/blog/categories">فئات</a>
                            </li>
                        @endcan
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_pages_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/pages', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/pages">القائمة</a>
                            </li>
                        @endcan()
                        ...
                        @can('admin_pages_create')
                            <li class="{{ request()->is(getAdminPanelUrl('/pages/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/pages/create">صفحة جديدة</a>
                            </li>
                        @endcan()
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_testimonials_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/testimonials', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/testimonials">القائمة</a>
                            </li>
                        @endcan()
                        ...
                        @can('admin_testimonials_create')
                            <li class="{{ request()->is(getAdminPanelUrl('/testimonials/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/testimonials/create">اضف الجديد</a>
                            </li>
                        @endcan()
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_discount_codes_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/financial/discounts', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/financial/discounts">القائمة</a>
                            </li>
                        @endcan
                        ...
                        @can('admin_discount_codes_create')
                            <li
                                ...
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/financial/discounts/new">اضف كود</a>
                            </li>
                        @endcan
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_product_discount_list')
                            <li
                                ...
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/financial/special_offers">القائمة</a>
                            </li>
                        @endcan
                        ...
                        @can('admin_product_discount_create')
                            <li
                                ...
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/financial/special_offers/new">اضف</a>
                            </li>
                        @endcan
                    </ul>
                </li>

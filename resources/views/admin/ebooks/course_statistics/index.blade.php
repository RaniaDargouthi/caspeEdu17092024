                ...
                <div class="col-12 col-md-3 mt-3">
                    <div class="course-statistic-cards-shadow py-3 px-2 py-md-3 px-md-3 rounded-sm bg-white">
                        <div class="d-flex align-items-center flex-column">
                            ...
                            <span class="font-30 text-dark mt-3 font-weight-bold">{{ $book->quizzes->count() }}</span>
                ...
                <div class="col-12 col-md-3 mt-3">
                    <div class="course-statistic-cards-shadow py-3 px-2 py-md-3 px-md-3 rounded-sm bg-white">
                        <div class="d-flex align-items-center flex-column">
                            ...
                            <span class="font-30 text-dark mt-3 font-weight-bold">{{ $book->assignments->count() }}</span>

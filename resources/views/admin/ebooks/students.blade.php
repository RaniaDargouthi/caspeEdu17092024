    ...
    <div class="card">
        <div class="card-header">
            @can('admin_webinar_notification_to_students')
                <a href="{{ getAdminPanelUrl() }}/webinars/{{ $book->id }}/sendNotification" class="btn btn-primary mr-2">{{ trans('notification.send_notification') }}</a>
            @endcan
                    ...
                    @foreach($students as $student)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif(!empty($book->access_days) and !$book->checkHasExpiredAccessDays($student->purchase_date, $student->gift_id))
    ...
    <div id="addStudentToCourseModal" class="d-none">
        ...
        <div class="mt-25">
            <form action="{{ getAdminPanelUrl() }}/enrollments/store" method="post">
                <input type="hidden" name="webinar_id" value="{{ $book->id }}">

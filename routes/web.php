...
Route::group(['namespace' => 'Web', 'middleware' => ['check_mobile_app', 'impersonate', 'share', 'check_maintenance']], function () {
    ...
    Route::get('/QuizzesType', function () {
        return view('web.default.pages.QuizzesType');
    })->name('QuizzesType');
    Route::get('/QuizzesType/reading', function () {
        return view('web.default.pages.quizzes.reading.r1');
    })->name('reading.r1');
    Route::get('/QuizzesType/reading/niveau', function () {
        return view('web.default.pages.quizzes.reading.niveauReading');
    })->name('reading.niveauReading');
//navbar
Route::get('/contact-us', 'HomeController@contactUs');
Route::get('/levelTests', 'HomeController@levelTests');
Route::get('/levels', 'HomeController@levels');

    Route::get('/ebooks', 'HomeController@ebooks');
    Route::get('/quizzes', 'HomeController@testQuizzes');
    // Route::get('/test-quizzes', 'HomeController@levelTests');
    Route::get('/cds', 'HomeController@cds');
